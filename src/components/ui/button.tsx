...
const variants = {
  primary:
    "bg-primary text-white hover:brightness-110 focus-visible:ring-primary/40",
  secondary:
  ...
  outline:
    "border-2 border-primary text-primary bg-transparent hover:bg-primary hover:text-white focus-visible:ring-primary/40",
  ghost:
