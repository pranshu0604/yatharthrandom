        ...
        <div className="grid grid-cols-1 gap-12 py-16 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8 lg:py-24">
          ...
          <div className="sm:col-span-2 lg:col-span-1 pr-8">
            <Link href="/" className="inline-flex items-center gap-2 group">
              <div className="h-8 w-8 bg-secondary rounded-lg flex items-center justify-center text-black font-bold text-lg">
                R
              </div>
            ...
            <div className="mt-8 flex gap-4">
              ...
              {["Twitter", "Instagram", "LinkedIn"].map((social) => (
                <a
                  ...
                  href="#"
                  aria-label={social}
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-neutral-400 transition-all duration-300 hover:bg-white/10 hover:text-white"
                >
